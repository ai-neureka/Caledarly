...
//
//     final allActivityInstancesModel = allActivityInstancesModelFromJson(jsonString);

import 'dart:convert';

AllActivityInstancesModel allActivityInstancesModelFromJson(String str) =>
    AllActivityInstancesModel.fromJson(json.decode(str));

String allActivityInstancesModelToJson(AllActivityInstancesModel data) =>
    json.encode(data.toJson());

class AllActivityInstancesModel {
  bool? success;
  List<ScheduleDatum>? data;
  Pagination? pagination;

  AllActivityInstancesModel({this.success, this.data, this.pagination});

  factory AllActivityInstancesModel.fromJson(Map<String, dynamic> json) =>
      AllActivityInstancesModel(
